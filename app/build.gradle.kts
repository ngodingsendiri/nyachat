...
private val appVersion: String = project.findProperty("appVersion") as String? ?: "r1.3.0"
private val appVersionCode: Int = (project.findProperty("appVersionCode") as String?)?.toIntOrNull() ?: 28
